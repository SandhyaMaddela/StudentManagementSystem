...
import LMS.dao.StudentDaoInterface;
import LMS.dao.UserDao;
import LMS.dao.UserDaoInterface;
...
public class SMS {
            ...
            switch (loginChoice) {
                case 1:
                    ...
                    if (userDao.loginUser(username, password)) {
                        ...
                        // Proceed to SMS functionalities
                        runSMS(sc);
                    } else {
    ...
    public static void runSMS(Scanner sc) {
        // Student Management System functionalities
        // Add your existing SMS functionalities here
